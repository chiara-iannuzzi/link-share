...
-- AddForeignKey
ALTER TABLE "Links" ADD CONSTRAINT "Links_socialNetworkId_fkey" FOREIGN KEY ("socialNetworkId") REFERENCES "SocialNetwork"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
